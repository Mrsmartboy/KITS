              ...
              {questions.map((question, index) => {
                ...
                return (
                  <tr
                    ...
                    onClick={() => {
                      navigate(`/code-playground/solve/${question.questionId}`, {
                        state: {
                          subjectname,
                          topicname,
                          subtopic,
