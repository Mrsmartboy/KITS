    ...
    <div className="team-page bg-white">
      <header className="header">
        <h1 className='team-heading'>
          <img src="/images/mark.png" alt='mark' className='mark' width={35} height={35}/>
      ...
      <section className="team-members">
        <div className="team-card sairam">
          <img src="/images/sairam.png" alt="Uppugundla Sairam" className="profile-pic" width="150" 
            height="150"/>
          ...
          <a href="https://www.instagram.com/sairamuppugandla?igsh=MWVub3o5OXFvZWhvdA==" target="_blank" rel="noreferrer">
              <img src="/images/insta.png" alt="Instagram" width="50" 
              height="50"/>
            </a>
        ...
        <div className="team-card saketh">
          <img src="/images/saketh.png" alt="Kallepu Saketh Reddy" className="profile-pic" width="150" 
           height="150"/>
      ...
      <section className="description">
        ...
        <ul>
          <li>
          <img src="/images/tick-mark.png" alt="tickMark" className='tick-mark' width="20" 
          height="20"/>
