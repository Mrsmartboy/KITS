...
const ExamCard = ({ exam, totalScore, maxScore, attempted }) => {
  ...
  const handleViewReport = () => {
    ...
    navigate("/exam-analysis", { state: { exam: { ...exam }, isReports: true } });
  };

  return (
    <div
      className="w-full bg-white shadow-[0px_4px_17px_rgba(19,46,224,0.2)] rounded-[26px] p-6 flex flex-col items-center"
    >
      {/* Exam Name */}
      <div className="text-xl font-medium text-black mb-4 text-center">{exam.examName || "Unnamed Exam"}</div>
      ...
      <button
        ...
        className="mt-4 px-4 py-2 w-[220px] h-[40px] bg-[#00007F] rounded-[6px] text-white text-base font-medium"
      >
      ...
      <div className="w-full px-4 mb-6 flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="custom-date-input-wrapper">
            ...
            />
            <FiCalendar
              className="custom-date-icon absolute right-3 top-1/2 transform -translate-y-1/2 text-[#00007F]"
              size={18}
  ...
  const renderExamCards = () => {
        ...
        <>
          ...
          <div className="text-center text-lg font-medium text-[#777777] mt-10">
            ...
            <button
              ...
              className="ml-2 px-3 py-1 bg-[#00007F] text-white text-sm font-medium rounded-[6px] hover:bg-[#000066]"
            >
              Clear Filter
            </button>
          </div>
    ...
    return (
      <>
        {renderHeader()}
        {/* Cards Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-12 w-full px-4">
